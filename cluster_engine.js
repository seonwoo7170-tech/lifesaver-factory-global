...
async function writeAndPost(model, target, lang, blogger, bId, pTime, extraLinks = [], idx, total, searchQuery = '', globalArchives = []) {
    ...
    const langTag = `\\n[STRICT_LANGUAGE_MODE]: You MUST write EVERYTHING (Title, Body, Meta Data, Table of Contents) in ${lang === 'ko' ? 'KOREAN' : 'ENGLISH'}. DO NOT mix languages. DO NOT use any other language than ${lang === 'ko' ? 'Korean' : 'English'}.\\n[TARGET_COUNTRY_CONTEXT]: ${lang === 'ko' ? 'South Korea' : 'USA/Global'}`;
